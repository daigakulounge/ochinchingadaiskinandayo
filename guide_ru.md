...
(_[ютюб линки добавить в readme.md]_ тут используют мнемонические изображения, советую просто срисовывать и сопоставлять с написанием каны, и не забывать пытаться выговаривать за японской-ведущей. У меня ушло 4 дня, по 30 минут в день)
...
Отличный справочник грамматики есть на [itazuraneko](LINK), им можно пользоваться и продвинутым пользователям.
